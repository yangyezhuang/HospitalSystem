...
<div class="form-box">
    ...
    <div class="form-bottom">
        ...
        <span><a href="register.jsp" class="pull-right">用户注册</a></span>
        <br>
        <span><a style="color: deepskyblue" href="admin/index.jsp">管理员登陆</a></span>
        <span><a style="color: deepskyblue" href="doctor/index.jsp" class="pull-right">医生登录</a></span>
    </div>
